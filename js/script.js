...
closeRef.addEventListener("click", closeModal);
...
listRef.addEventListener("click", (evt) => {
  ...
  const description = evt.target.alt;
    ...
    openModal(largeImageUrl, description);
...
document.addEventListener("keydown", (evt) => {
  ...
  if (evt.code === "ArrowRight") {
    ...
    modalImageRef.src = galleryItems[currentIndex].original;
    modalImageRef.alt = galleryItems[currentIndex].description;
  }
